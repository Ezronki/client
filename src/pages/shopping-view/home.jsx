      ...
      <section className="bg-black py-12 mt-3 mx-4 lg:mx-20 rounded-2xl">
        <div className="container mx-auto px-4 lg:px-20">
          ...
          <section className="bg-black py-8">
            <div className="w-full md:w-2/3 pr-4 mb-6 md:mb-0 h-64">
              <img
                src={HeaderImage}
                alt="Header"
                className="w-full h-full object-cover rounded-2xl shadow-2xl ring-2 ring-gray-600"
                loading="eager"
              />
            </div>

            {/* Right Column */}
            <div className="w-full md:w-1/3 pl-4 flex items-center justify-center h-64">
              <img
                src={SudoImage}
                alt="Sudo"
                className="w-full h-full object-cover rounded-2xl shadow-2xl ring-2 ring-gray-600"
